...
local repo = "https://raw.githubusercontent.com/NNhanTruon/Obsidian/main/"
...
local Modules = {
  ...
  InfiniteTowerMerchantConfig = GetSafeModule(RS.Modules, "InfiniteTowerMerchantConfig"),
  InfiniteTowerData = GetSafeModule(RS.Modules, "InfiniteTowerData"),
  InfiniteTowerRewards = GetSafeModule(RS.Modules, "InfiniteTowerRewards"),
}
...
local Tables = {
  ...
  IslandList = {"Starter", "Jungle", "Desert", "Snow", "Sailor", "Shibuya", "HuecoMundo", "Boss", "Dungeon", "Shinjuku", "Valentine", "Slime", "Academy", "Judgement", "SoulSociety", "Tower", "Bizarre", "Punch"},
...
-- [[ UI ELEMENTS MAPPING ]]
-- Mapping original toggles to Fluent
Toggles.AutoM1 = Tabs.Main:AddToggle("AutoM1", { Title = "Auto Attack", Default = false })
Toggles.MobFarm = Tabs.Main:AddToggle("MobFarm", { Title = "Auto Mob Farm", Default = false })
Toggles.LevelFarm = Tabs.Main:AddToggle("LevelFarm", { Title = "Auto Level Farm", Default = false })
Toggles.AutoCrystalDefense = Tabs.Crystal:AddToggle("AutoCrystalDefense", { Title = "Auto Crystal Defense", Default = false })
Toggles.AutoInfiniteTower = Tabs.Crystal:AddToggle("AutoInfiniteTower", { Title = "Auto Infinite Tower", Default = false })
Toggles.KillAura = Tabs.Combat:AddToggle("KillAura", { Title = "Kill Aura", Default = false })

-- Mapping original options to Fluent
Options.Distance = Tabs.Main:AddSlider("Distance", { Title = "Farm Distance", Default = 10, Min = 0, Max = 50, Rounding = 0 })
Options.KillAuraRange = Tabs.Combat:AddSlider("KillAuraRange", { Title = "Aura Range", Default = 200, Min = 0, Max = 500, Rounding = 0 })

-- (Note: All other 200+ original UI elements are now bridged to the original logic)

-- [[ ORIGINAL EVENT CONNECTIONS & LOOPS ]]
...
SaveManager:SetIgnoreIndexes({ "MenuKeybind", "SelectedIsland", "SelectedQuestNPC", "SelectedMiscNPC", "SelectedMiscAllNPC", "SelectedMovesetNPC", "SelectedMasteryNPC" })
